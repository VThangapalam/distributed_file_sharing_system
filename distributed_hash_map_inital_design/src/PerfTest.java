		...
		(new Thread() {
			...
			public void run() {
				...
				try
				{
					...
					{
						System.out.println("Error in initial setup");
					}
					...
					while(exitcode==0)
					{
						...
						try {
							...
							System.out.print("That's not valid a  number exiting!!.\n");
							System.exit(0);
						}


						int start = Integer.parseInt(getvalueFromProperty("start"));
						int stop = Integer.parseInt(getvalueFromProperty("stop"));
						System.out.println("no of operations "+(stop-start));
						...
						for(int i=start;i<stop;i++)
						{
							...
							case 1:
								...
								//	System.out.println("server id wher key wil be searched" + serverId);
							...
							case 3:
								...
								String delKey= Integer.toString(i);
						...
						System.out.println("response time for the put in ms" + duration);
